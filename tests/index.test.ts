...
describe('Connector', () => {
    ...
    describe('listNodes', () => {
        ...
        it('lists providers at the root path', async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith('https://api.db.nomics.world/v22/providers?limit=100&offset=0', expect.anything());
        ...
        it('lists datasets for a provider path', async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith('https://api.db.nomics.world/v22/datasets/IMF?limit=100&offset=0', expect.anything());
            expect(result.connectionNodeConfigs).toEqual([
        ...
        it('lists a single page of series for a dataset path, honoring limit/offset without looping', async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith('https://api.db.nomics.world/v22/series/IMF/AFRREO?limit=50&offset=50', expect.anything());
